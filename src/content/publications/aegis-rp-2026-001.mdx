...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem'}}>
  ...
  <tbody>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#767676'}}>Safe</td>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#4A4A4A'}}>Low</td>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#2D2D2D'}}>Medium</td>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>High</td>
    ...
    <tr>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#000000'}}>Critical</td>
...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem'}}>
  ...
  <tbody>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#767676'}}>Excellent</td>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#4A4A4A'}}>Strong</td>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>Good</td>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#2D2D2D'}}>Fair</td>
    ...
    <tr>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>Weak</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontFamily: 'monospace'}}>&lt; 100</td>
...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem'}}>
  ...
  <tbody>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', fontWeight: 700, color: '#000000'}}>Critical</td>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', fontWeight: 700, color: '#111111'}}>High</td>
    ...
    <tr>
      <td style={{padding: '10px 14px', fontWeight: 700, color: '#111111'}}>Default</td>
...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem'}}>
  ...
  <tbody>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 600}}>High</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#000000', fontWeight: 700}}>Very High</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#2D2D2D', fontWeight: 600}}>Medium</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', textAlign: 'center', fontFamily: 'monospace'}}>5</td>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#2D2D2D', fontWeight: 600}}>Medium-Low</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem'}}>
  ...
  <tbody>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>1</td>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#2D2D2D'}}>2</td>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#2D2D2D'}}>3</td>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>4</td>
    ...
    <tr>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#767676'}}>5</td>
...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem'}}>
  ...
  <tbody>
    <tr style={{borderBottom: '1px solid #B5B5B5', backgroundColor: 'rgba(17, 17, 17, 0.06)'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>0.865</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5', backgroundColor: 'rgba(17, 17, 17, 0.05)'}}>
    ...
    <tr style={{backgroundColor: 'transparent'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#767676'}}>0.398</td>
    </tr>
  </tbody>
</table>
...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem'}}>
  ...
  <tbody>
    <tr style={{borderBottom: '1px solid #B5B5B5', backgroundColor: 'rgba(17, 17, 17, 0.06)'}}>
      <td style={{padding: '10px 14px', fontWeight: 600}}>GPT-5</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 700}}>1.0</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 700}}>1.0</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 700}}>1.0</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 700}}>1.0</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 700}}>1.0</td>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', fontWeight: 600}}>Claude Opus 4.6</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 700}}>1.0</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#2D2D2D'}}>0.75</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 700}}>1.0</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 700}}>1.0</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 700}}>1.0</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#2D2D2D'}}>0.75</td>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 700}}>1.0</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 700}}>1.0</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#767676', fontWeight: 700}}>0.0</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5', backgroundColor: 'rgba(17, 17, 17, 0.05)'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#767676', fontWeight: 700}}>0.0</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 700}}>1.0</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#2D2D2D'}}>0.5</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 700}}>1.0</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', fontWeight: 600}}>Grok 4.1 Fast</td>
    ...
    <tr style={{backgroundColor: 'rgba(17, 17, 17, 0.05)'}}>
      <td style={{padding: '10px 14px', fontWeight: 700}}>Mean ASR</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>1.000</td>
...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem'}}>
  ...
  <tbody>
    <tr style={{borderBottom: '1px solid #B5B5B5', backgroundColor: 'rgba(17, 17, 17, 0.06)'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>0.997</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#000000'}}>Critical</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', fontWeight: 600}}>Grok 3 Mini</td>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>0.99</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#000000'}}>Critical</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', fontWeight: 600}}>Grok 4.1 Fast</td>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>0.98</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#000000'}}>Critical</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', fontWeight: 600}}>DeepSeek (R1)</td>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>0.96</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#000000'}}>Critical</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', fontWeight: 600}}>DeepSeek Chat</td>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>0.95</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#000000'}}>Critical</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', fontWeight: 600}}>Claude Opus 4.6</td>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>0.93</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#000000'}}>Critical</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5', backgroundColor: 'rgba(17, 17, 17, 0.05)'}}>
      <td style={{padding: '10px 14px', fontWeight: 600}}>Grok 4.1 (R)</td>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center'}}>0.80</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#2D2D2D'}}>0.90</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>High</td>
    </tr>
    <tr style={{backgroundColor: 'transparent'}}>
      <td style={{padding: '10px 14px', fontWeight: 600}}>Gemini 3.1 Pro</td>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center'}}>0.74</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#2D2D2D'}}>0.86</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>High</td>
    </tr>
  </tbody>
</table>
...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem'}}>
  ...
  <tbody>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 700}}>0.620</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#2D2D2D'}}>0.18</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#767676', fontWeight: 700}}>0.12</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', fontWeight: 600}}>Mean ASR@1000</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 700}}>0.96</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#2D2D2D'}}>0.45</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#767676', fontWeight: 700}}>0.30</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', fontWeight: 600}}>Mean α</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111'}}>0.34</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#2D2D2D'}}>0.75</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#767676', fontWeight: 700}}>0.95</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', fontWeight: 600}}>Mean π</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111'}}>0.03</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#2D2D2D'}}>0.15</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#767676', fontWeight: 700}}>0.35</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px', fontWeight: 600}}>Mean Budget@0.5</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111'}}>3</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#2D2D2D'}}>85</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#767676', fontWeight: 700}}>450</td>
    </tr>
    <tr>
      <td style={{padding: '10px 14px', fontWeight: 600}}>Defense Grade</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#111111', fontWeight: 700}}>Weak</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#2D2D2D', fontWeight: 700}}>Fair</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#767676', fontWeight: 700}}>Good</td>
    </tr>
  </tbody>
</table>
...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem'}}>
  ...
  <tbody>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontFamily: 'monospace'}}>0.30</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontFamily: 'monospace'}}>0.35</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#767676', fontWeight: 600}}>+8% defense rate</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontFamily: 'monospace'}}>0.25</td>
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#767676', fontWeight: 600}}>+12% defense rate</td>
    </tr>
    <tr>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', color: '#767676', fontWeight: 700}}>+17% defense rate</td>
    </tr>
  </tbody>
</table>
...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem'}}>
  ...
  <tbody>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#767676'}}>&lt; 0.1ms</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '10px 14px'}}>PALADIN Pipeline P50</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#767676'}}>~2ms</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      ...
      <td style={{padding: '10px 14px', textAlign: 'center', fontWeight: 700, color: '#767676'}}>50,000+ RPS</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
