...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem'}}>
  ...
  <tbody>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      ...
      <td style={{padding: '12px 16px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>0.99969</td>
      <td style={{padding: '12px 16px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>0.99974</td>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5', backgroundColor: 'rgba(17, 17, 17, 0.05)'}}>
      ...
      <td style={{padding: '12px 16px', textAlign: 'center', fontWeight: 700, color: '#767676'}}>135M</td>
      <td style={{padding: '12px 16px', textAlign: 'center'}}>0.99780</td>
      <td style={{padding: '12px 16px', textAlign: 'center'}}>0.99813</td>
      <td style={{padding: '12px 16px', textAlign: 'center', fontWeight: 700, color: '#767676'}}>129.5 MB</td>
      <td style={{padding: '12px 16px', textAlign: 'center', fontWeight: 700, color: '#767676'}}>16 min</td>
    </tr>
    <tr>
...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem'}}>
  ...
  <tbody>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5', backgroundColor: 'transparent'}}>
      ...
      <td style={{padding: '12px 16px', textAlign: 'center', fontWeight: 700, color: '#767676', fontSize: '1.1rem'}}>100% (9/9)</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
    ...
    <tr>
      ...
      <td style={{padding: '12px 16px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>7.6 ms/sample</td>
    </tr>
  </tbody>
</table>
...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem'}}>
  ...
  <tbody>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '12px 16px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>1</td>
      <td style={{padding: '12px 16px'}}>Deployment size</td>
      <td style={{padding: '12px 16px', textAlign: 'center'}}>&lt; 150 MB</td>
      <td style={{padding: '12px 16px', textAlign: 'center', fontWeight: 700, color: '#767676'}}>129.5 MB</td>
    </tr>
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '12px 16px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>2</td>
    ...
    <tr style={{borderBottom: '1px solid #B5B5B5'}}>
      <td style={{padding: '12px 16px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>3</td>
      <td style={{padding: '12px 16px'}}>Inference speed</td>
      <td style={{padding: '12px 16px', textAlign: 'center'}}>Real-time</td>
      <td style={{padding: '12px 16px', textAlign: 'center', fontWeight: 700, color: '#767676'}}>7.6 ms/sample</td>
    </tr>
    <tr>
      <td style={{padding: '12px 16px', textAlign: 'center', fontWeight: 700, color: '#111111'}}>4</td>
      <td style={{padding: '12px 16px'}}>Label-specific accuracy</td>
